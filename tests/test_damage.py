"""Tests for the plan's damage formula:
...
# Weapon values from the game (game/weapons.py)
...
def test_con_armadura_reduce_el_dano():
    # armor 0.5 vs the pistol's 0.25 penetration → effective armor 0.25
...
def test_con_penetracion_mayor_a_la_armadura_la_anula_sin_bonus():
    # hammer pen 0.40 vs armor 0.30 → max(0, -0.10) = 0 → full damage, no more
